                    ...
                    <div id="box-user-update" style="display: none" class="box box-primary">
                        ...
                        <form role="form" id="form-user-update">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label for="exampleInputGenderM">
                                            <input value="M" checked type="radio" id="exampleInputGenderM"
                                                name="gender">
                                            Masculino</label>
                                    </div>
                                    <div class="radio">
                                        <label for="exampleInputGenderF">
                                            <input value="F" type="radio" id="exampleInputGenderF" name="gender">
                                            Feminino</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="photo" type="file" id="exampleInputFile" name="photo">
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" id="exampleInputAdmin" name="admin"> Administrador
                                    </label>
                                </div>
                            </div>
                            <!-- /.box-body -->
                            <div class="box-footer">
                                ...
                                <button type="button" class="btn btn-cancel btn-default">Cancelar</button>
                            </div>
                        </form>
                    </div>
