                        ...
                        <form role="form" id="form-user-create" wire:submit.prevent='store'>
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio">
                                        <label for="exampleInputGenderM">
                                            <input wire:model.lazy='gender' value="M" checked type="radio"
                                                id="exampleInputGenderM" name="gender">
                                            Masculino</label>
                                    </div>
                                    <div class="radio">
                                        <label for="exampleInputGenderF">
                                            <input wire:model.lazy='gender' value="F" type="radio"
                                ...
                                <div class="form-group">
                                    ...
                                    <select wire:model.lazy='country' class="form-control" id="exampleInputCountry"
                                        name="country">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input wire:model.lazy='isAdmin' type="checkbox" id="exampleInputAdmin"
